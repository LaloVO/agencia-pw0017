...
const PropertyMap = ({ properties, mapboxToken, centerLngLat }: PropertyMapProps) => {
  ...
  return (
    <div className="relative w-full h-full">
      {mapError ? (
        <div className="absolute inset-0 bg-slate-950 flex flex-col items-center justify-center p-6 text-center text-white border border-white/5 rounded-3xl">
          ...
          <p className="text-slate-500 text-[10px] uppercase tracking-widest font-extrabold">
